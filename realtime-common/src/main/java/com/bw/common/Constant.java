...
public class Constant {
    ...
    public static final String HBASE_NAMESPACE = "realtime_gmall2024";
    public static final String PROCESS_DATABASE = "realtime_conf";
    ...
    public static final String DORIS_DATABASE = "realtime_gmall";
